...
/* package interactive-visualisation-0.1.0.0 */
#define VERSION_interactive_visualisation "0.1.0.0"
#define MIN_VERSION_interactive_visualisation(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "interactive-visualisation-0.1.0.0"

#define CURRENT_PACKAGE_KEY "interactive-visualisation-0.1.0.0"
